 ...
 ***************************************************************************/
	...
	$result = mysql_query ( "SELECT * FROM ".$DBPrefix."auctions WHERE closed='0' AND suspended ='0' ORDER BY ends LIMIT intval($offset).",".intval($limit));
	...
	include "header.php";
	include phpa_include("template_view_ending_php.html");
	include "footer.php";
