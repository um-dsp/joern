...
$emailmode = $USERLANG = @mysql_result(@mysql_query("SELECT endemailmode FROM ".$DBPrefix."users WHERE id='".$Seller['id']."'"),0,"endemailmode");
...
$buffer = file($main_path."language/".$USERLANG."/mail_endauction_winner_pay.inc.php");
