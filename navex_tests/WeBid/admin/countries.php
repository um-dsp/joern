  ...
  */
  for ( $i = 0; $i < count($_POST[old_countries]); $i++) {
    ...
    if ( $old_countries[$i] != $new_countries[$i]) {
      $sqlstr = "UPDATE ".$DBPrefix."countries SET country = \"" .
  ...
  <tr>
    <td background="images/bac_barint.gif"><table width="100%" border="0" cellspacing="5" cellpadding="0">
        <tr>
          ...
          <td class=white><?=$MSG_5142?>&nbsp;&gt;&gt;&nbsp;<?=$MSG_081?></td>
        </tr>
      </table></td>
  </tr>
  <tr>
          ...
          <TD><CENTER>
            ...
            <FORM NAME=conf action="<?=basename($_SERVER['PHP_SELF'])?>" METHOD=POST>
              <TABLE WIDTH="95%" BORDER="0" CELLSPACING="0" CELLPADDING="1" BGCOLOR="#0083D7" ALIGN="CENTER">
                <TR>
                  <TD ALIGN=CENTER class=title><?php print $MSG_081; ?></TD>
                </TR>
                <TR>
                  <TD><TABLE WIDTH=100% CELLPADDING=2 BGCOLOR="#FFFFFF">
                      ...
                      <TR>
                        <TD WIDTH=50></TD>
                        <TD BGCOLOR="#EEEEEE"><B> <?php print $MSG_087; ?> </B> </TD>
                        <TD BGCOLOR="#EEEEEE" align=center><B> <?php print $MSG_008; ?> </B> </TD>
                      </TR>
                      <?php
                    ...
                    <TR>
                      ...
                      <TR>
                        <TD WIDTH=50></TD>
                        <TD><INPUT TYPE="submit" NAME="act" VALUE="<?php print $MSG_089; ?>">
                        </TD>
                      </TR>
                      <TR>
                        <TD WIDTH=50></TD>
