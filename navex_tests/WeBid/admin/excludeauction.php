...
if(!$action || ($action && $updated)){
	...
	$query = "select a.id, u.nick, a.title, a.starts, a.description,
		...
		a.quantity, a.reserve_price, a.location, a.minimum_bid from ".$DBPrefix."auctions
	...
	while (list ($code, $descr) = each ($countries)) {
		...
		if ($descr == $country) $country_list .= " selected";
