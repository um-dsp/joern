...
#//
$query = "SELECT defaultcountry FROM ".$DBPrefix."settings";
$res = @mysql_query($query);
if(!$res) {
	print "Error: $query<BR>".mysql_error();
	exit;
  ...
  <TR>
	...
	<FORM NAME=conf ACTION=<?=basename($_SERVER[PHP_SELF])?> METHOD=POST>
	  <TABLE WIDTH="95%" BORDER="0" CELLSPACING="0" CELLPADDING="1" BGCOLOR="#0083D7">
		<TR>
		  <TD ALIGN=CENTER class=title><?php print $MSG_5322; ?></TD>
		</TR>
		<TR>
		  <TD><TABLE WIDTH=100% CELLPADDING=2 ALIGN="CENTER" BGCOLOR="#FFFFFF">
			  ...
			  <TR VALIGN="TOP">
				<TD WIDTH=169>&nbsp;</TD>
				<TD WIDTH="365"> <?php print $MSG_5321; ?> </TD>
			  </TR>
			  <TR VALIGN="TOP">
				<TD WIDTH=169 HEIGHT="22"> <?php print $MSG_5322; ?> </TD>
			  ...
			  <TR>
				...
				<TD WIDTH="368"><INPUT TYPE="submit" NAME="act" VALUE="<?php print $MSG_530; ?>">
				</TD>
			  </TR>
			  <TR>
				<TD WIDTH=116></TD>
